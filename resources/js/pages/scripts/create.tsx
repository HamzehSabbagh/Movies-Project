...
export default function Create({ movies, artists }: Props) {
    ...
    return <div className="min-h-screen bg-gray-50">
        ...
        <div className='mx-auto w-full max-w-2xl px-4 py-10'>
            ...
            >
                <div>
                    <p className="text-2xl font-semibold text-gray-900">Create Script</p>
                    <p className="text-sm text-gray-500">Add a screenplay and link it to a movie and artist.</p>
                </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                    <Link href='/scripts' className='rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-100'>Back</Link>
